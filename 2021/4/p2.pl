...
loser([Call | _], [Board]-[], Score) :-
    ...
    Score is Sum * Call.
loser([_ | Calls], [Board]-[], Score) :- loser(Calls, [Board]-[], Score).
loser([_ | Calls], []-Boards, Score) :- loser(Calls, Boards-[], Score).
loser([Call | Calls], [Board | Boards]-Done, Score) :-
    mark(Call, Board, Marked),
    ( is_win(Marked) -> loser([Call | Calls], Boards-Done, Score)
    ; loser([Call | Calls], Boards-[Marked | Done], Score)).
